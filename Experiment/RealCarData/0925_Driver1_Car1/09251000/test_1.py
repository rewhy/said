...
def loadtest():
    #打开OBD文件中的speed和转角
    test_steerfilename='uds_09251000开发SkodaDT_steerAngle.txt'
    test_speedfilename='uds_09251000开发SkodaDT_vehicleSpeed.txt'
...
def test(x,y):
    ...
    plt.show()
    return Y_label
model_name='C:/Users/73608/lunwen/DMS_HKPU/系统化整理 - 副本/0925开发_skoda/09251000/0327.h5'
